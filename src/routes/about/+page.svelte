<div
	class="mt-[40px] px-(--mobile-padding) pb-2 lg:mt-[84px] lg:h-[65.5vh] lg:px-(--desktop-padding)"
>
	<div class="mx-auto pt-10 text-center text-5xl text-black lg:text-7xl">
		<h1 class="mb-10 border-b-2 pb-8">About Me</h1>
	</div>

	<div class="flex w-full justify-center">
		<p class="text-text-primary max-w-[45ch] text-left text-2xl lg:max-w-none lg:text-3xl">
